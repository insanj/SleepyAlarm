...
#define IS_IOS8_OR_NEWER (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_8_0)
...
- (NSArray *)buttonsInActionSheetSubviews
{
    ...
    for (id subView in self.subviews) {
        ...
        else if (IS_IOS8_OR_NEWER && [subView isKindOfClass:[UILabel class]]) {
            [buttons addObject:subView];
        }
    }
    return buttons;
